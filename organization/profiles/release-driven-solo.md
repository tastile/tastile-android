...
- workspace/Core domain authority and Android project architecture remain canonical for product behavior.
- Gradle version catalog / Android SDK / Kotlin / Compose pinning stays ecosystem-native; bunx is agent-tooling only.
- device/instrumented verification evidence must bind to the tested APK/AAB and source SHA.
