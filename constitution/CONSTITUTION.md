# Tastile Android Constitution

この文書は、Tastile Android の repository-local 開発組織における最上位 contract です。
...
Tastile Android の開発組織の目的は current procedure への服従ではありません。
...
Cross-repository product / infrastructure decisions are coordinated by `tastile/tastile-root`. This repository-local Constitution remains compatible with that shared contract.
