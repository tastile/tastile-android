...
public abstract class Hilt_ExecutionAlarmReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((ExecutionAlarmReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectExecutionAlarmReceiver(UnsafeCasts.<ExecutionAlarmReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
