 ...
 * `AppSectionHeaderInline` wrapper living in `core.designsystem.component`.
 *
 ...
 * `app.tastile.android.core.designsystem.component.AppSectionHeaderInline`.
 */
package app.tastile.android.ui.mobile.components

import androidx.compose.runtime.Composable
import androidx.compose.ui.Modifier
import app.tastile.android.core.designsystem.component.AppSectionHeaderInline as CoreAppSectionHeader
...
fun AppSectionHeader(
    ...
    CoreAppSectionHeader(title = title, modifier = modifier)
}
