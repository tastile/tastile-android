...
/**
 * Tastile navigation bar with content slot. Wraps Material 3 [NavigationBar].
 *
...
/**
 * Tastile navigation rail item with icon and label content slots. Wraps Material 3
 * [NavigationRailItem].
 *
 * @param selected Whether this item is selected.
 * @param onClick The callback to be invoked when this item is selected.
...
/**
 * Tastile navigation rail with header and content slots. Wraps Material 3 [NavigationRail].
 *
...
/**
 * Tastile navigation suite scaffold with item and content slots.
...
/**
 * Tastile navigation default values.
 */
