...
/**
 * Tastile view toggle button with included trailing icon as well as compact and expanded
...
/**
 * Internal Tastile view toggle button content layout for arranging the text label and
 * trailing icon.
 *
...
/**
 * Tastile view toggle default values.
 */
